...
import { MobilePage } from '@e2e/pc-web/src/pages/MobilePage.js';
...
export class MobileSteps extends BaseActions {
  ...
  async mobileTest(): Promise<boolean> {
    return this.runTestSteps(
      [
        () => this.mobilePage.testStartAndMovePage(this.platform, urlLocator.mobile[this.platform], uiLocator.mobileMenu[this.uiType]),
