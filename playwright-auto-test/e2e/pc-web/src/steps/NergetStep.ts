...
import { NergetPage } from '@e2e/pc-web/src/pages/NergetPage.js';
...
export class NergetSteps extends BaseActions {
  ...
  async nergetTest(): Promise<boolean> {
    return this.runTestSteps(
      [
        () => this.nergetPage.testStartAndMovePage(this.platform, urlLocator.nerget[this.platform], uiLocator.nurgetMenu[this.uiType]),
