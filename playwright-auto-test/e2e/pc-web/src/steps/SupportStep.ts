...
import { SupportPage } from '@e2e/pc-web/src/pages/SupportPage.js';
...
export class SupportSteps extends BaseActions {
  ...
  async supportTest(): Promise<boolean> {
    return this.runTestSteps(
      [
        () => this.supportPage.testStartAndMovePage(this.platform, urlLocator.support[this.platform], uiLocator.supportMenu[this.uiType]),
