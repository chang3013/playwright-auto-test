...
import { IptvPage } from '@e2e/pc-mobile-web/src/pages/IptvPage.js';
...
export class IptvSteps extends BaseActions {
  ...
  async iptvTest(): Promise<boolean> {
    return this.runTestSteps(
      [
        () => this.iptvPage.testStartAndMovePage(this.platform, urlLocator.iptv[this.platform], uiLocator.internetMenu[this.uiType], uiLocator.subMainBtn[this.uiType]),
