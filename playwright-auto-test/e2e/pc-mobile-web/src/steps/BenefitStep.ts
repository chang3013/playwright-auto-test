...
import { BenefitPage } from '@e2e/pc-mobile-web/src/pages/BenefitPage.js';
...
export class BenefitSteps extends BaseActions {
  ...
  async benefitTest(): Promise<boolean> {
    return this.runTestSteps(
      [
        () => this.benefitPage.testStartAndMovePage(this.platform, urlLocator.benefit[this.platform], uiLocator.benefitMenu[this.uiType], uiLocator.subMainBtn[this.uiType]),
